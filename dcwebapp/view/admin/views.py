...
from dcwebapp.view.admin import admin
...
from dcwebapp.model.models import Document, Project, User, db, Laboratory
from dcwebapp.view.admin.forms import AddinfoForm, AddDocumentForm, AddProjectForm, AddAdminForm, AddMemberForm, AddLabForm, \
    AddActivityForm
